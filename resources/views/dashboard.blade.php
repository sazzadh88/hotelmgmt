...
@section('panel')
       ...
       <div class="content-main">
        ...
        <link rel="stylesheet" href="{{ asset('template/css/graph.css') }}">
        ...
        <div class="content-mid">
            ...
            <link rel="stylesheet" href="{{ asset('template/css/clndr.css') }}" type="text/css" />
            ...
            <script src="{{ asset('template/js/clndr.js') }}" type="text/javascript"></script>
            <script src="{{ asset('template/js/site.js') }}" type="text/javascript"></script>
        ...
        <div id="owl-demo" class="owl-carousel text-center">
            <div class="item">
                <img class="lazyOwl img-responsive" data-src="template/images/na.jpg" alt="name">
            </div>
            <div class="item">
                <img class="lazyOwl img-responsive" data-src="template/images/na1.jpg" alt="name">
            </div>
            <div class="item">
                <img class="lazyOwl img-responsive" data-src="template/images/na2.jpg" alt="name">
            </div>
            <div class="item">
                <img class="lazyOwl img-responsive" data-src="template/images/na.jpg" alt="name">
            </div>
        ...
        <div class="content-bottom">
            ...
            <div class="post-bottom">
                <div class="post-bottom-1">
                    <a href="template/#"><i class="fa fa-facebook"></i></a>
                    <p>15k <label>Likes</label></p>
                </div>
                <div class="post-bottom-2">
                    <a href="template/#"><i class="fa fa-twitter"></i></a>
